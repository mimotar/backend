...
export type SettingMinAggregateOutputType = {
  user_id: number | null
  id: number | null
  defaultCurrency: $Enums.DefaultCurrency | null
...
export type SettingWhereInput = {
  ...
  user_id?: Prisma.IntFilter<"Setting"> | number
...
export type SettingScalarWhereWithAggregatesInput = {
  ...
  user_id?: Prisma.IntWithAggregatesFilter<"Setting"> | number
...
export type EnumDefaultCurrencyFieldUpdateOperationsInput = {
  set?: $Enums.DefaultCurrency
}
...
export interface SettingDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const settingWithUser_idOnly = await prisma.setting.findMany({ select: { user_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Settings and only return the `user_id`
   * const settingWithUser_idOnly = await prisma.setting.createManyAndReturn({
   *   select: { user_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Settings and only return the `user_id`
   * const settingWithUser_idOnly = await prisma.setting.updateManyAndReturn({
   *   select: { user_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface SettingFieldRefs {
  readonly user_id: Prisma.FieldRef<"Setting", 'Int'>
