    ...
    schemas: {
      ...
      TransactionLogs: {
        ...
        properties: {
          ...
          payment_sent_to_escrow_at: { type: "string", format: "date-time", nullable: true, example: "2026-03-01T14:00:00.000Z" },
      ...
      TransactionFile: {
        type: "object",
        properties: {
          fileName: { type: "string", example: "brief.pdf" },
          fileType: { type: "string", enum: ["image", "pdf", "doc", "other"], example: "pdf" },
      ...
      PaymentResponse: {
        ...
        properties: {
          ...
          transaction_reference: { type: "string", example: "MIM-TXN-101" },
          amount: { type: "integer", example: 50000 },
          payment_method: {
            type: "string",
            enum: ["BANK_TRANSFER", "ATM_CARD", "INTERNET_BANKING"],
            example: "ATM_CARD",
          },
          status: {
            type: "string",
          ...
          title: { type: "string", example: "Escrow payment" },
          created_at: { type: "string", format: "date-time", example: "2026-03-01T14:00:00.000Z" },
          updated_at: { type: "string", format: "date-time", example: "2026-03-01T14:01:00.000Z" },
        },
      },
      EarningsResponse: {
        type: "object",
        properties: {
          ...
          amount: { type: "string", description: "Decimal serialized as string", example: "48500.00" },
      ...
      TransactionResponse: {
        ...
        properties: {
          ...
          creator_fullname: { type: "string", example: "Ada Lovelace" },
          creator_email: { type: "string", format: "email", example: "ada@example.com" },
          creator_no: { type: "string", example: "+2348012345678" },
          creator_address: { type: "string", nullable: true, example: "Lagos, NG" },
          creator_role: { type: "string", enum: ["CLIENT", "FREELANCER"], example: "CLIENT" },
          receiver_fullname: { type: "string", example: "Grace Hopper" },
          reciever_email: { type: "string", format: "email", example: "grace@example.com" },
          receiver_no: { type: "string", example: "+2348098765432" },
          receiver_address: { type: "string", nullable: true },
          reciever_role: { type: "string", enum: ["CLIENT", "FREELANCER"], example: "FREELANCER" },
          pay_escrow_fee: { type: "string", enum: ["CLIENT", "FREELANCER", "BOTH"], example: "CLIENT" },
          pay_shipping_cost: {
            type: "string",
          ...
          inspection_duration: { type: "integer", example: 48 },
          expiresAt: { type: "string", format: "date-time", example: "2026-03-08T10:00:00.000Z" },
          link_expires: { type: "boolean", example: false },
          txn_link: { type: "string", example: "https://app.mimotar.com/txn/abc" },
          transactionToken: { type: "string", example: "tok_abc123" },
          approveStatus: { type: "boolean", example: true },
          rejection_reason: { type: "string", nullable: true },
          user_id: { type: "integer", nullable: true, example: 7 },
          payment_id: { type: "integer", nullable: true, example: 12 },
          files: {
            type: "array",
            nullable: true,
          ...
          change_requested_at: { type: "string", format: "date-time", nullable: true },
          change_requested_by_email: { type: "string", nullable: true },
          revision_count: { type: "integer", example: 0 },
          cancel_requested_by_email: { type: "string", nullable: true },
          cancel_requested_at: { type: "string", format: "date-time", nullable: true },
          cancel_reason: { type: "string", nullable: true },
          cancel_approved_at: { type: "string", format: "date-time", nullable: true },
          ...
          earnings: {
            type: "array",
            items: { $ref: "#/components/schemas/EarningsResponse" },
          },
          deadlineExtensions: {
            type: "array",
            items: { $ref: "#/components/schemas/DeadlineExtension" },
        ...
        example: {
          ...
          currency: "NGN",
          status: "ONGOING",
          transaction_description: "Full landing page redesign",
          transactionType: "SERVICE",
          creator_fullname: "Ada Lovelace",
          creator_email: "ada@example.com",
          creator_no: "+2348012345678",
          creator_address: "Lagos, NG",
          creator_role: "CLIENT",
          receiver_fullname: "Grace Hopper",
          reciever_email: "grace@example.com",
          receiver_no: "+2348098765432",
          receiver_address: null,
          reciever_role: "FREELANCER",
          pay_escrow_fee: "CLIENT",
          pay_shipping_cost: null,
          terms: null,
          additional_agreement: null,
          inspection_duration: 48,
          expiresAt: "2026-03-08T10:00:00.000Z",
          link_expires: false,
          txn_link: "https://app.mimotar.com/txn/abc",
          transactionToken: "tok_abc123",
          approveStatus: true,
          ...
          change_requested_by_email: null,
          revision_count: 0,
          ...
          payment: {
            id: 12,
            transaction_id: 101,
            transaction_reference: "MIM-TXN-101",
            amount: 50000,
            payment_method: "ATM_CARD",
            status: "COMPLETED",
            title: "Escrow payment",
            created_at: "2026-03-01T14:00:00.000Z",
            updated_at: "2026-03-01T14:01:00.000Z",
          },
          dispute: [],
          earnings: [],
          deadlineExtensions: [],
      ...
      ProjectListItem: {
        ...
        properties: {
          ...
          transactionType: {
            type: "string",
            enum: ["PHYSICAL_PRODUCT", "ONLINE_PRODUCT", "SERVICE", "RENTAL", "MILESTONE_BASED_PROJECT"],
            example: "MILESTONE_BASED_PROJECT",
          },
          creator_fullname: { type: "string", example: "Ada Lovelace" },
          creator_email: { type: "string", format: "email", example: "ada@example.com" },
          creator_address: { type: "string", nullable: true },
          ...
          link_expires: { type: "boolean" },
          txn_link: { type: "string" },
          ...
          myRole: { type: "string", enum: ["CLIENT", "FREELANCER"], example: "CLIENT" },
          counterparty: {
            type: "object",
          ...
          dueAt: { type: "string", format: "date-time", example: "2026-04-01T00:00:00.000Z" },
          milestoneSummary: {
            type: "object",
            nullable: true,
            properties: {
              total: { type: "integer", example: 3 },
              activeIndex: { type: "integer", nullable: true, example: 1 },
              completedCount: { type: "integer", example: 0 },
              active: {
                type: "object",
                nullable: true,
                properties: {
